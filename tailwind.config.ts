  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        flicker: {
          "0%,19%,21%,23%,25%,54%,56%,100%": { opacity: "1", textShadow: "0 0 12px hsl(0 90% 50% / 0.7), 0 0 28px hsl(0 90% 40% / 0.4)" },
          "20%,24%,55%": { opacity: "0.55", textShadow: "none" },
        },
        "pulse-blood": {
          "0%,100%": { boxShadow: "0 0 18px hsl(0 80% 40% / 0.4)" },
          "50%": { boxShadow: "0 0 38px hsl(0 90% 50% / 0.7)" },
        },
        fog: {
      ...
      animation: {
        ...
        "pulse-blood": "pulse-blood 2.8s ease-in-out infinite",
